<?php
// Force template version - DELETE THIS LINE AFTER TESTING
echo '<!-- TEMPLATE LOADED: Version 9.9.0 @ ' . date('Y-m-d H:i:s') . ' -->';
/**
 * Login Form
 *
...
<div class="login_tabs_section">
		<div class="login_tabs active_tab">
				Login
		</div>
		<a class="login_tabs" href="<?php echo bloginfo('url'); ?>/register">
				Register
		</a>
</div>
